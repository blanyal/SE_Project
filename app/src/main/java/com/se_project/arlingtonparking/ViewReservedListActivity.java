...
public class ViewReservedListActivity extends AppCompatActivity implements com.se_project.arlingtonparking.MyRecyclerViewAdapter2.ItemClickListener {
    Button return_button;
    private String new_username = "";
    private RecyclerView recyclerView;
    private com.se_project.arlingtonparking.MyRecyclerViewAdapter2 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new com.se_project.arlingtonparking.MyRecyclerViewAdapter2(this, reservations);
...
class MyRecyclerViewAdapter3 extends RecyclerView.Adapter<com.se_project.arlingtonparking.MyRecyclerViewAdapter3.ViewHolder> {
    ...
    private com.se_project.arlingtonparking.MyRecyclerViewAdapter2.ItemClickListener mClickListener;
    ...
    void setClickListener(com.se_project.arlingtonparking.MyRecyclerViewAdapter2.ItemClickListener itemClickListener) {
